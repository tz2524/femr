...
//        }
    ...
    private void getSecondaryData(ResearchResultSetItem resultSet, ResearchFilterItem filters, ResearchResultItem resultItem, IResearchEncounter encounter) {
    ...
    private ResearchResultSetItem buildVitalResultSet(List<? extends IResearchEncounter> encounters, ResearchFilterItem filters) {
        ...
        for (IResearchEncounter encounter : encounters) {
            ...
            if (filters.getSecondaryDataset() != null) {
                getSecondaryData(resultSet, filters, resultItem,encounter);
            }
