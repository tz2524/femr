...
public class PatientService implements IPatientService {
    ...
    public ServiceResponse<PatientItem> createPatient(PatientItem patient) {
        ...
        try {
            IPatient newPatient = dataModelMapper.createPatient(patient.getUserId(), patient.getFirstName(), patient.getLastName(), patient.getBirth(), patient.getSex(), patient.getAddress(), patient.getCity(), patient.getPhotoId(), patient.getBirthdayIsFake());
